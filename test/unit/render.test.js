...
describe('lib/render', function() {
    it('should work as expected', function() {
        return render('test/fixtures/render-1.scss', {outputStyle: "compressed"})
        .then(function(css) {
    ...
    it('should write to a file if specified', function() {
        ...
        return render('test/fixtures/render-1.scss', tmp.path, {outputStyle: "compressed"})
        .then(function() {
    ...
    it("should resolve output base on `root` file if it's relative", function() {
        return render('test/fixtures/render-1.scss', 'test/fixtures/output.css', {outputStyle: "compressed"})
        .then(function(out) {
